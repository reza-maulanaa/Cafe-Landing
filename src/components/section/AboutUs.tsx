    ...
    >
      <div className="mx-auto grid max-w-6xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <div className="order-2 lg:order-1">
          ...
          <p
            data-reveal
            className="mt-5 text-base leading-relaxed text-espresso/70 sm:text-lg"
          >
        ...
        <div
          data-reveal
          className="order-1 overflow-hidden rounded-3xl border border-espresso/10 shadow-sm lg:order-2"
        >
          <Image
